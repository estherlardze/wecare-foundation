  ...
  return (
    <div className="bg-hero bg-cover bg-no-repeat bg-center mt-[60px]  h-[60vh] sm:h-[100vh] w-full 2xl:h-[60vh] bg-fixed">
      <div className="bg-black/50 h-[60vh] sm:h-[100vh] w-full 2xl:h-[60vh] text-white gap-4">
        <div className="w-[86%] mx-[7%] flex flex-col items-center justify-center h-[60vh] sm:h-[100vh] 2xl:h-[60vh]">
          <h1 className="font-bold text-2xl sm:text-3xl text-center mb-4">
            We are creating a brighter tomorrow
          </h1>
          <p className="text-3xl sm:text-4xl md:text-6xl text-center font-bold my-6">
