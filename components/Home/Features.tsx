...
const Features = () => {
  return (
    <div className="bg-black/5">
      <section className="my-[70px] text-black/90 flex flex-col md:flex-row gap-10 md:gap-5 mx-[7%] w-[86%]">
        ...
        <div>
          {features.map((feature) => (
            <article key={feature.id} className="flex flex-col sm:flex-row gap-2 sm:gap-6 mb-3">
              <h1>
