...
const Donation = () => {
  return (
    <section className="w-[86%] mx-[7%] my-[70px] text-black/85">
      <h1 className="uppercase text-xl text-center font-bold text-black/80 mb-3 overflow-hidden" data-aos="fade-up">
        Donations
      </h1>
      <h3 className="capitalize text-center text-xl font-[500]" data-aos="fade-up">What we do</h3>
